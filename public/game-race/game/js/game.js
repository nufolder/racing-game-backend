...
function updateGame() {
    ...
    if (!gameData.paused) {
        ...
        playerData.score += Math.floor((dataCurrent * Math.round(defaultData.speed / score_value_data)) * .03);
        updateGameStatus();
    }
}
