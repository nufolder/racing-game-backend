...
<div class="add-life">
    ...
    <div class="container bg-red pb-5">
        ...
        <div class="item disabled">
            <a class="btn" style="background-color: #FFBF86">
                <div class="row">
                    <div class="col-4">
                    ...
                    <div class="col-8 texting">
                        ...
                        <p class="card-text">KAMU TELAH MEMAINKAN TRIVIA HARI INI</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        @if ($statusM == false)
        <div class="item disabled">
            <a href="" class="btn" style="background-color: #FFBF86">
                <div class="row">
                    <div class="col-4">
                    ...
                    <div class="col-8 texting">
                        ...
                        <p class="card-text">KAMU TELAH MEMAINKAN GAME INI HARI INI</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="" class="btn" style="background-color: #FFBF86">
                <div class="row">
                    ...
                    <div class="col-8 texting">
                        ...
                        <p class="card-text">KAMU TELAH MENONTON VIDEO HARI INI</p>
            ...
            <div class="item-share">
                <div class="d-flex flex-wrap ">
                    <div class="col-5 d-flex flex-wrap justify-content-between px-3 align-items-center">
                        ...
                        <a href="https://twitter.com/intent/tweet?url={{ url('/') }}" target="_blank"><img
